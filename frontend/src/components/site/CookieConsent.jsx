      ...
      {show && (
        ...
        >
          <div className="flex items-start gap-3">
            <Cookie className="h-5 w-5 text-steel-bright flex-shrink-0 mt-0.5" />
            <div>
              ...
              <div className="mt-5 flex gap-3">
                <button
                  ...
                  className="bg-steel px-5 py-2.5 font-mono text-[11px] font-semibold uppercase tracking-[0.14em] text-white transition-colors hover:bg-steel-hover"
                >
                  Accept
                </button>
                <button
