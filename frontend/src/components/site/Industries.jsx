        ...
        {industries.map((ind, i) => (
          ...
          >
            ...
            >
              ...
              <span className="ledger-key relative z-10 transition-colors group-hover:text-steel-bright">
              ...
              <span className="absolute inset-x-0 bottom-0 h-px origin-left scale-x-0 bg-steel-bright transition-transform duration-500 group-hover:scale-x-100" />
            </Link>
          </motion.div>
        ))}
      </div>
