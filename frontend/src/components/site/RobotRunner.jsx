      ...
      <div ref={jumpRef}>
        <div ref={squashRef} className="rb-inner">
          <svg ref={svgRef} className="robot" width="36" height="26" viewBox="0 0 42 30" fill="none">
            ...
            <g className="laptop">
              <rect x="19" y="20" width="15" height="2.6" rx="0.7" fill="#1A1A2E" stroke="#3B82F6" strokeWidth="0.6" />
              <g className="laptop-lid">
                <rect x="19" y="12" width="13" height="8" rx="0.7" fill="#14141f" stroke="#3B82F6" strokeWidth="0.7" />
                <rect x="19.8" y="12.8" width="11.4" height="6.4" rx="0.4" fill="#3B82F6" opacity="0.55" />
                <rect className="laptop-cursor" x="21" y="14" width="0.9" height="3" fill="#ffffff" />
              </g>
            </g>
            {/* arms */}
            <rect className="arm-l" x="3" y="11" width="1.7" height="6" rx="0.8" fill="#3B82F6" />
            <rect className="arm-r" x="14.8" y="11" width="1.7" height="6" rx="0.8" fill="#3B82F6" />
            {/* legs */}
            <rect className="leg-l" x="7.2" y="20" width="1.8" height="5.5" rx="0.8" fill="#3B82F6" />
            <rect className="leg-r" x="11.2" y="20" width="1.8" height="5.5" rx="0.8" fill="#3B82F6" />
            {/* body */}
            <rect x="5.5" y="10.5" width="9" height="9.5" rx="1" fill="#3B82F6" />
            {/* head */}
            <rect x="5" y="1" width="10" height="8.5" rx="1.5" fill="#7C3AED" />
