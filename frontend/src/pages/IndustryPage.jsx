...
const ResultMetric = ({ r, index }) => {
  ...
  return (
    <div ref={ref} className="rule pt-6">
      ...
      <div className="mt-3 font-display text-[clamp(2.5rem,6vw,4rem)] leading-[0.9] text-steel-bright tabular-nums">
            ...
            {industry.automations.map((a, i) => (
              <Reveal key={i} delay={i * 0.06}>
                <div className="led-row group flex gap-6 sm:gap-10 py-6">
                  <span className="ledger-key pt-1 transition-colors group-hover:text-steel-bright">
          ...
          <Reveal>
            <div className="flex flex-col items-start gap-8 pt-4 md:flex-row md:items-end md:justify-between">
              ...
              <a
                ...
                className="group inline-flex shrink-0 items-center gap-3 bg-steel px-8 py-4 text-sm font-semibold uppercase tracking-[0.12em] text-white transition-colors hover:bg-steel-hover"
              >
                Get a Quote
